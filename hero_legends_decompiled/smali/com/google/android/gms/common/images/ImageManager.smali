...
# static fields
.field private static final ob:Ljava/lang/Object;

.field private static oc:Ljava/util/HashSet;
...
.field private static od:Lcom/google/android/gms/common/images/ImageManager;

.field private static oe:Lcom/google/android/gms/common/images/ImageManager;
...
.field private final of:Ljava/util/concurrent/ExecutorService;

.field private final og:Lcom/google/android/gms/common/images/ImageManager$b;

.field private final oh:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
.field private final oi:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->ob:Ljava/lang/Object;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->oc:Ljava/util/HashSet;
...
.method private constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->of:Ljava/util/concurrent/ExecutorService;
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->og:Lcom/google/android/gms/common/images/ImageManager$b;

    invoke-static {}, Lcom/google/android/gms/internal/fg;->cG()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0}, Lcom/google/android/gms/common/images/ImageManager;->bz()V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->oh:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->oi:Ljava/util/Map;
...
.method private a(Lcom/google/android/gms/common/images/a$a;)Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->og:Lcom/google/android/gms/common/images/ImageManager$b;
...
.method public static a(Landroid/content/Context;Z)Lcom/google/android/gms/common/images/ImageManager;
    ...
    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->oe:Lcom/google/android/gms/common/images/ImageManager;
    ...
    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->oe:Lcom/google/android/gms/common/images/ImageManager;
    ...
    :cond_1
    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->od:Lcom/google/android/gms/common/images/ImageManager;
    ...
    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->od:Lcom/google/android/gms/common/images/ImageManager;
...
.method static synthetic aZ()Ljava/lang/Object;
    ...
    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->ob:Ljava/lang/Object;
...
.method static synthetic b(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->oi:Ljava/util/Map;
...
.method private b(Lcom/google/android/gms/common/images/a;)Z
    ...
    invoke-static {v0}, Lcom/google/android/gms/internal/ds;->N(Ljava/lang/String;)V

    iget v0, p1, Lcom/google/android/gms/common/images/a;->os:I
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->oh:Ljava/util/Map;
    ...
    :cond_1
    iget-boolean v2, v0, Lcom/google/android/gms/common/images/ImageManager$ImageReceiver;->ok:Z
    ...
    :cond_2
    iget-object v2, p0, Lcom/google/android/gms/common/images/ImageManager;->oh:Ljava/util/Map;
...
.method static synthetic bA()Ljava/util/HashSet;
    .locals 1

    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->oc:Ljava/util/HashSet;
...
.method private bz()V
    ...
    iget-object v2, p0, Lcom/google/android/gms/common/images/ImageManager;->og:Lcom/google/android/gms/common/images/ImageManager$b;
...
.method static synthetic d(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/concurrent/ExecutorService;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->of:Ljava/util/concurrent/ExecutorService;
...
.method public loadImage(Landroid/widget/ImageView;Landroid/net/Uri;I)V
    ...
    invoke-virtual {v0, p3}, Lcom/google/android/gms/common/images/a;->F(I)V
